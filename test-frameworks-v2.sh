...
# Define test projects with unique names to avoid "already exists" errors
PROJECTS=(
  "validate-django|django|vue|postgres|native|nginx|django-test.com|false"
  "validate-spring|springboot|nextjs|mysql|native|nginx|spring-test.com|false"
  "validate-go|go|svelte|redis|native|nginx|go-test.com|false"
  "validate-dotnet|dotnet|angular|postgres|native|nginx|dotnet-test.com|false"
)

echo "Starting MasterOps Framework Validation Suite (Unique Names)..."
echo "===================================================="
